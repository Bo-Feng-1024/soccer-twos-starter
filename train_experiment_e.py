"""
Experiment E: Observation normalization (MeanStdFilter) + from checkpoint-5122.

Hypothesis: Raw observations have variable magnitudes. Running mean-variance
normalization is one of the most impactful PPO implementation details (37 Details).
We've never tried it.

Note: Restored checkpoint has no filter statistics, so first few hundred
iterations may show temporary performance drop while statistics converge.
"""
import os
import pickle
